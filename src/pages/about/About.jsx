...
const About = () => {
  return (
    <section className="px-2 py-12  bg-stone-300 md:px-0">
    ...
    <figure className="mx-auto max-w-2xl">
      <h1 className="mb-4 text-3xl text-center font-semibold text-black md:text-5xl"> Hello! I'm Kunal Deotale</h1>
      <blockquote className="mt-10 text-xl font-medium text-gray-700">
        <p>
          “ A Full Stack Developer, With 1200+ Hours Of Coding Practice, 300+ Hours Of Data Structure And Algorithms. High Adaptability To Learn And Collaborate In A Rapidly Changing Environment. As A Full Stack Developer, I'm Well Versed In The Latest Front End Technologies Such As React, Redux, And Chakra UI, And Have Worked With Node.js, Express.js, Mongo DB, And Other Back End Tools. Looking Forward To Working As A Web Developer With A Reputed Firm Driven By Technology.”
        </p>
      </blockquote>
